...
Se muestra que, a partir de las pocas características obtenidas de los datos, el modelo es capaz de obtener resultados de forma rápida, especialmente teniendo en cuenta el escaso ajuste que se realiza en el modelo en si y la poca cantidad de datos empleados para el entrenamieto del modelo
