...
La duración promedio general de nuestras señales es de `r mean(longitudes)` con una desciación típica de `r sd(longitudes)`. Además, la duración en función del tipo de onda es la siguiente:
