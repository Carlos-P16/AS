...
En este caso, el desafio presente consiste en el diagnóstico eficiente de anomalias en el pulso cardíaco
para fomentar a un diagnóstico precoz de enfermedades como __EXPLICAR__


## Comprensión de los datos

Para nuestro estudio se toma como fuente de datos un fichero csv obtenido del sitio web del siguiente enlace__,
donde a su vez se puede encontrar el significado de los metadatos proporcionados. La información más relevante es la siguiente:
